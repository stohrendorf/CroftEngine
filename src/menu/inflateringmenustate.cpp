...
namespace menu
{
std::unique_ptr<MenuState> InflateRingMenuState::tick(engine::world::World& /*world*/, MenuDisplay& display)
{
...
void InflateRingMenuState::constructUi(ui::Ui& /*ui*/, engine::world::World& /*world*/, MenuDisplay& /*display*/)
{
}

void InflateRingMenuState::handleObjectTick(engine::world::World& world, MenuDisplay& display, MenuObject& object)
{
...
void InflateRingMenuState::begin(engine::world::World& /*world*/)
{
  ...
  m_radiusSpeed = (MenuRingTransform::IdleCameraZPosOffset - m_ringTransform->radius) / Duration * 1_tick;
  m_cameraSpeedY = (MenuRingTransform::IdleCameraYPosOffset - m_ringTransform->cameraPos.Y) / Duration * 1_tick;
