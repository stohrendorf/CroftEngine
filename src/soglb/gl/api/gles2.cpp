...
void primitiveBoundingBox(
  float minX, float minY, float minZ, float minW, float maxX, float maxY, float maxZ, float maxW)
{
  return glPrimitiveBoundingBox(static_cast<GLfloat>(minX),
                                static_cast<GLfloat>(minY),
                                static_cast<GLfloat>(minZ),
                                static_cast<GLfloat>(minW),
                                static_cast<GLfloat>(maxX),
                                static_cast<GLfloat>(maxY),
                                static_cast<GLfloat>(maxZ),
                                static_cast<GLfloat>(maxW));
}
