...
namespace level
{
    ...
    public:
        ...
        static std::unique_ptr<Level> createLoader(const std::string& filename, Game gameVersion,
        ...
        std::vector<std::shared_ptr<gameplay::gl::Texture>> createTextures(
        ...
        void drawBars(gameplay::Game* game,
                      const std::shared_ptr<gameplay::gl::Image<gameplay::gl::RGBA8>>& image) const;
