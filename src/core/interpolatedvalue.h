...
public:
    ...
    SelfType& add(const T& v, int ms)
    {
        m_value += scale(v, ms);
        return *this;
    }

    SelfType& add(const SelfType& v, int ms)
    {
        m_value += v.getScaled(ms);
        return *this;
    }

    SelfType& sub(const T& v, int ms)
    {
        m_value -= scale(v, ms);
        return *this;
    }

    SelfType& sub(const SelfType& v, int ms)
    {
        m_value -= v.getScaled(ms);
        return *this;
    }

    T getScaled(int ms) const noexcept
    {
    ...
    static constexpr T scale(const T& v, int ms)
    {
