...
std::vector<NamedInputMappingConfig> getDefaultModernMappings()
{
  return {
    {
...
std::vector<NamedInputMappingConfig> getDefaultClassicMappings()
{
  return {
    {
      pgettext("Input|MappingName", /* translators: TR charmap encoding */ "Keyboard"),
      "PS",
      {
        {GlfwKey::LeftShift, Action::Walk},
        {GlfwKey::LeftControl, Action::Action},
        {GlfwKey::Space, Action::Holster},
        {GlfwKey::LeftAlt, Action::Jump},
        {GlfwKey::End, Action::Roll},
        {GlfwKey::Kp0, Action::FreeLook},
        {GlfwKey::Escape, Action::Menu},
        {GlfwKey::Num1, Action::DrawPistols},
        {GlfwKey::Num2, Action::DrawShotgun},
        ...
        {GlfwKey::F5, Action::Save},
        {GlfwKey::F6, Action::Load},
        {GlfwKey::Left, Action::Left},
        {GlfwKey::Right, Action::Right},
        {GlfwKey::Up, Action::Forward},
        {GlfwKey::Down, Action::Backward},
        {GlfwKey::Delete, Action::StepLeft},
        {GlfwKey::PageDown, Action::StepRight},
        {GlfwKey::F12, Action::Screenshot},
        {GlfwKey::F1, Action::BugReport},
      },
      {
        {GlfwKey::Left, Action::MenuLeft},
        {GlfwKey::Right, Action::MenuRight},
        {GlfwKey::Up, Action::MenuUp},
        {GlfwKey::Down, Action::MenuDown},
        {GlfwKey::Delete, Action::PrevScreen},
        {GlfwKey::PageDown, Action::NextScreen},
        {GlfwKey::LeftControl, Action::PrimaryInteraction},
        {GlfwKey::Space, Action::SecondaryInteraction},
        {GlfwKey::Escape, Action::Return},
        {GlfwKey::F10, Action::CheatDive} // only available in debug builds
      },
    },
...
void EngineConfig::deserialize(const serialization::Deserializer<EngineConfig>& ser)
{
  ser(S_NVD("renderSettings", std::ref(renderSettings), render::RenderSettings{}),
      ...
      S_NVD("inputMappings", std::ref(inputMappings), getDefaultModernMappings()),
...
EngineConfig::EngineConfig()
    : inputMappings{getDefaultModernMappings()}
{
}
