...
const std::map<std::variant<serialization::NamedEnum<GlfwKey, EnumUtil<GlfwKey>>,
                            serialization::NamedEnum<GlfwGamepadButton, EnumUtil<GlfwGamepadButton>>>,
               serialization::NamedEnum<Action, EnumUtil<Action>>>
  defaultMapping{
