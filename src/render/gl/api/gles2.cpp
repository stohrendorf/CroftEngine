...
void getInternalformat(TextureTarget target, InternalFormat internalformat, InternalFormatPName pname, core::SizeType count, int32_t *params)
{
    return glGetInternalformativ(static_cast<GLenum>(target), static_cast<GLenum>(internalformat), static_cast<GLenum>(pname), static_cast<GLsizei>(count), detail::constAway(reinterpret_cast<GLint *>(params)));
}
...
{
    return glGetSynciv(static_cast<GLsync>(sync), static_cast<GLenum>(pname), static_cast<GLsizei>(count), detail::constAway(reinterpret_cast<GLsizei *>(length)), detail::constAway(reinterpret_cast<GLint *>(values)));
}
...
void texImage3D(TextureTarget target, int32_t level, InternalFormat internalformat, core::SizeType width, core::SizeType height, core::SizeType depth, int32_t border, PixelFormat format, PixelType type, const void *pixels)
{
    return glTexImage3D(static_cast<GLenum>(target), static_cast<GLint>(level), static_cast<GLenum>(internalformat), static_cast<GLsizei>(width), static_cast<GLsizei>(height), static_cast<GLsizei>(depth), static_cast<GLint>(border), static_cast<GLenum>(format), static_cast<GLenum>(type), detail::constAway(pixels));
}
...
void getProgramResource(uint32_t program, ProgramInterface programInterface, uint32_t index, core::SizeType propCount, const ProgramResourceProperty *props, core::SizeType count, core::SizeType *length, int32_t *params)
{
    return glGetProgramResourceiv(static_cast<GLuint>(program), static_cast<GLenum>(programInterface), static_cast<GLuint>(index), static_cast<GLsizei>(propCount), detail::constAway(reinterpret_cast<const GLenum *>(props)), static_cast<GLsizei>(count), detail::constAway(reinterpret_cast<GLsizei *>(length)), detail::constAway(reinterpret_cast<GLint *>(params)));
}
