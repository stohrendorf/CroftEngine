...
public:
    explicit Program(const std::string& label = {})
        : BindableResource{[](const ::gl::GLsizei n, ::gl::GLuint* handle) {
    ...
    {
    public:
        explicit ActiveUniform(const ::gl::GLuint program,
                               const ::gl::GLuint index,
                               const ::gl::GLint maxLength,
            ...
            : m_program{program}
        {
            ...
            case ::gl::GL_SAMPLER_BUFFER: m_samplerIndex = samplerIndex; samplerIndex += m_size;
            default: break;
            }
        }
        ...
        {
            BOOST_ASSERT(values != nullptr);
            GL_ASSERT(glProgramUniformMatrix4fv(
                m_program, m_location, count, ::gl::GL_FALSE, reinterpret_cast<const ::gl::GLfloat*>(values)));
        }
        ...
        void set(const glm::vec2* values, const ::gl::GLsizei count)
        {
            BOOST_ASSERT(values != nullptr);
            GL_ASSERT(
                glProgramUniform2fv(m_program, m_location, count, reinterpret_cast<const ::gl::GLfloat*>(values)));
        }
        ...
        void set(const glm::vec3* values, const ::gl::GLsizei count)
        {
            BOOST_ASSERT(values != nullptr);
            GL_ASSERT(
                glProgramUniform3fv(m_program, m_location, count, reinterpret_cast<const ::gl::GLfloat*>(values)));
        }
        ...
        void set(const glm::vec4* values, const ::gl::GLsizei count)
        {
            BOOST_ASSERT(values != nullptr);
            GL_ASSERT(
                glProgramUniform4fv(m_program, m_location, count, reinterpret_cast<const ::gl::GLfloat*>(values)));
        }
        ...
        void set(const std::vector<std::shared_ptr<Texture>>& values)
        {
            ...
            GL_ASSERT(
                glProgramUniform1iv(m_program, m_location, static_cast<::gl::GLsizei>(values.size()), units.data()));
        }
