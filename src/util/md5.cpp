...
inline void FF(uint32_t& a, const uint32_t b, const uint32_t c, const uint32_t d, const uint32_t x, const uint32_t s,
               const uint32_t ac)
{
    a = rotate_left( a + F( b, c, d ) + x + ac, s ) + b;
}

inline void GG(uint32_t& a, const uint32_t b, const uint32_t c, const uint32_t d, const uint32_t x, const uint32_t s,
               const uint32_t ac)
{
    a = rotate_left( a + G( b, c, d ) + x + ac, s ) + b;
}

inline void HH(uint32_t& a, const uint32_t b, const uint32_t c, const uint32_t d, const uint32_t x, const uint32_t s,
               const uint32_t ac)
{
    a = rotate_left( a + H( b, c, d ) + x + ac, s ) + b;
}

inline void II(uint32_t& a, const uint32_t b, const uint32_t c, const uint32_t d, const uint32_t x, const uint32_t s,
               const uint32_t ac)
{
