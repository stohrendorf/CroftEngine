...
void runGame(const std::string& localeOverride, const std::string& gameflowId,bool isFullscreenborderless)
{
...
int main(int argc, char** argv)
{
  ...
  while(true)
  {
    ...
    bool isfullscreenBorderless = false;
    {
      ...
      isfullscreenBorderless = std::get<2>(*launcherResult);
    }
    ...
    runGame(localeOverride, gameflowId,isfullscreenBorderless);
  }
}
