...
std::shared_ptr<AnimationController> AnimationController::create(irr::scene::IAnimatedMeshSceneNode* node, const Level* level, const AnimatedModel& model, const std::string& name)
{
