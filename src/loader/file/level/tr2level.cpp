...
void TR2Level::loadFileData()
{
    ...
    m_reader.readVector( m_rooms, m_reader.readU16(), loader::file::Room::readTr2 );
    ...
    m_reader.readVector( m_items, m_reader.readU32(), &loader::file::Item::readTr2 );
    ...
    m_reader.readVector( m_soundDetails, m_reader.readU32(), &loader::file::SoundDetails::readTr1 );
