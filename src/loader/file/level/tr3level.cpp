...
void TR3Level::loadFileData()
{
    ...
    m_palette = loader::file::Palette::readTr1( m_reader );
    /*Palette palette16 =*/ loader::file::Palette::readTr2( m_reader );

    const auto numTextiles = m_reader.readU32();
    std::vector<loader::file::ByteTexture> texture8;
    m_reader.readVector( texture8, numTextiles, &loader::file::ByteTexture::read );
    std::vector<loader::file::WordTexture> texture16;
    m_reader.readVector( texture16, numTextiles, &loader::file::WordTexture::read );
    ...
    m_reader.readVector( m_rooms, m_reader.readU16(), &loader::file::Room::readTr3 );

    m_reader.readVector( m_floorData, m_reader.readU32() );

    readMeshData( m_reader );

    m_reader.readVector( m_animations, m_reader.readU32(), &loader::file::Animation::readTr1 );

    m_reader.readVector( m_transitions, m_reader.readU32(), &loader::file::Transitions::read );

    m_reader.readVector( m_transitionCases, m_reader.readU32(), &loader::file::TransitionCase::read );
    ...
    m_reader.readVector( m_staticMeshes, m_reader.readU32(), &loader::file::StaticMesh::read );

    m_reader.readVector( m_sprites, m_reader.readU32(), &loader::file::Sprite::readTr1 );
    ...
    m_reader.readVector( m_cameras, m_reader.readU32(), &loader::file::Camera::read );

    m_reader.readVector( m_soundSources, m_reader.readU32(), &loader::file::SoundSource::read, &m_soundEngine );

    m_reader.readVector( m_boxes, m_reader.readU32(), &loader::file::Box::readTr2 );
    ...
    m_reader.readVector( m_textureProxies, m_reader.readU32(), &loader::file::TextureLayoutProxy::readTr1 );

    m_reader.readVector( m_items, m_reader.readU32(), &loader::file::Item::readTr3 );

    m_lightmap = loader::file::LightMap::read( m_reader );

    m_reader.readVector( m_cinematicFrames, m_reader.readU16(), &loader::file::CinematicFrame::read );
    ...
    m_reader.readVector( m_soundDetails, m_reader.readU32(), &loader::file::SoundDetails::readTr3 );
    ...
    loader::file::io::SDLReader newsrc( m_sfxPath );
    if( !newsrc.isOpen() )
    {
