...
void TR1Level::loadFileData()
{
    ...
    m_reader.readVector( texture8, m_reader.readU32(), &loader::file::ByteTexture::read );
    ...
    m_reader.readVector( m_rooms, m_reader.readU16(), &loader::file::Room::readTr1 );
    ...
    BOOST_LOG_TRIVIAL( debug ) << "Reading sprite sequences";
    {
        ...
        for( uint32_t i = 0; i < n; ++i )
        {
            auto m = loader::file::SpriteSequence::readTr1( m_reader );
    ...
    m_reader.readVector( m_boxes, m_reader.readU32(), &loader::file::Box::readTr1 );
    ...
    m_reader.readVector( m_items, m_reader.readU32(), &loader::file::Item::readTr1 );
