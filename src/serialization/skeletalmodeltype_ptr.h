...
{
inline core::TypeId::type ptrSave(const loader::file::SkeletalModelType* model,
...
inline const loader::file::SkeletalModelType* ptrLoad(const TypeId<const loader::file::SkeletalModelType*>&,
